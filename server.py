...
class handle_data():
    ...
    def save_course(self,title,disc,cat,level,req,outcome,price,discount,channel,url,thmb,mkey,mdisc,mail,mobile):
        ...
        values=(title,disc,cat,level,req,outcome,price,discount,channel,url,thmb,mkey,mdisc,mail,mobile)
        print(values)
...
def coursB():
    return render_template("courseBasic.html")

@app.route("/coursesReq")
def coursR():
    return render_template("courseReq.html")

@app.route("/coursesOutcome")
def coursO():
    return render_template("courseOutcome.html")

@app.route("/coursesPrice")
def courseP():
    return render_template("coursePrice.html")

@app.route("/coursesMedia")
def courseM():
    return render_template("courseMedia.html")
...
def courseF():
    return render_template("courseFinish.html")
...
def addinstructorlist():
    return render_template("addinstructorlist.html")
...
def instructorPay():
    return render_template("Instructorpayout.html")
...
def preview():
    ...
    return cert.pre(cert.path+req["font"],names[0],int(req["size"]),req["col"])
